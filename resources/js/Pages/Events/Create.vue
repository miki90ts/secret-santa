                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
                                    <div v-if="form.errors.registration_start" class="text-red-600 text-sm mt-1">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
                                    <div v-if="form.errors.registration_end" class="text-red-600 text-sm mt-1">
                            ...
                            <p class="text-sm text-gray-600">
                                Napomena: Aktiviranjem ovog događaja, svi drugi događaji će biti deaktivirani.
                            </p>
