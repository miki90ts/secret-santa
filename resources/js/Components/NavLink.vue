...
const classes = computed(() =>
    props.active
        ? "inline-flex items-center px-1 pt-1 border-indigo-400 border-indigo-600 text-sm font-medium leading-5 text-gray-900 text-gray-100 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out"
